...
| 기준 버전 | `main`+피드백 반영 빌드 (M1~M5 완료, 2026-08-14) |
...
src/
  ...
  data/               시드 데이터 (매장·리뷰·NPC·랜드마크·이벤트·상점·커뮤니티)
  store/              Zustand 스토어 12종 — localStorage `toktown:*` 키로 영속
