  ...
  return (
    <aside className="flex flex-col gap-3">
      ...
      <div className="rounded-2xl border border-town-line bg-town-paper/70 p-3 text-[12px] leading-relaxed text-town-inkSoft">
        ...
        동물 주민이 하나씩 입주해요
        <br />
        <b>🔨 배치 모드</b>(🎒 버튼): 캐릭터·주민이 잠시 퇴장 → 빈 곳 드래그 =
        카메라, 오브젝트 탭/드래그 = 선택·이동, <b>✓ 배치 확정</b> / <b>✕ 보관함
        반환</b> → 완료로 복귀
        <br />
        광장의 <b>돌바닥 타일 21칸·가로등 4개</b>도 기본 배치물이라 탭해서
        회수·재배치할 수 있고, 돌바닥 위엔 건물·랜드마크를 제외한 <b>1×1 소형
        오브젝트</b>를 올릴 수 있어요
      </div>
    </aside>
  );
